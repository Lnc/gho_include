...
#ifndef GHO_VECTOR_ULLINT_H
#define GHO_VECTOR_ULLINT_H

#include "../int/ullint.h"


#define gho_vector_T gho_vector_ullint
#define gho_vector_T_t gho_vector_ullint_t

#define T_t gho_ullint

#define gho_type_vector_T GHO_TYPE_VECTOR_ULLINT
...
#define gho_T_fread gho_ullint_fread

// T gho_T_sread(char**);
#define gho_T_sread gho_ullint_sread
...
#define gho_T_compare gho_ullint_compare
...
#ifdef DOXYGEN
/**
 * @brief Vector of gho_ullint (unsigned long long int)
 * 
 * @see gho_vector_T_t for documentation
 */
struct gho_vector_ullint_t { };
#endif
