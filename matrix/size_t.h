...
#ifndef GHO_MATRIX_SIZE_T_H
#define GHO_MATRIX_SIZE_T_H

#include "../int/size_t.h"


#define gho_matrix_T gho_matrix_size_t
#define gho_matrix_T_t gho_matrix_size_t_t

#define T_t size_t

#define gho_type_matrix_T GHO_TYPE_MATRIX_SIZE_T
...
#ifdef DOXYGEN
/**
 * @brief Matrix of size_t
 * 
 * @see gho_matrix_T_t for documentation
 */
struct gho_matrix_size_t_t { };
#endif
