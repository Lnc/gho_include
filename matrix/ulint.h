...
#ifndef GHO_MATRIX_ULINT_H
#define GHO_MATRIX_ULINT_H

#include "../int/ulint.h"


#define gho_matrix_T gho_matrix_ulint
#define gho_matrix_T_t gho_matrix_ulint_t

#define T_t gho_ulint

#define gho_type_matrix_T GHO_TYPE_MATRIX_ULINT
...
#ifdef DOXYGEN
/**
 * @brief Matrix of gho_ulint (unsigned long int)
 * 
 * @see gho_matrix_T_t for documentation
 */
struct gho_matrix_ulint_t { };
#endif
