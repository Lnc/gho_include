...
/**
 * \brief Print a gho_mpz_t in a file with indentation
...
/**
 * \brief Print a gho_mpz_t in a C string with indentation
...
/**
 * \brief Equality between two gho_mpz_t
...
/**
 * \brief Equality between a gho_mpz_t and a gho_lint
 * \param[in] a A gho_mpz_t
...
/**
 * \brief Compare a gho_mpz_t and a gho_lint
 * \param[in] a A gho_mpz_t
 * \param[in] b A gho_lint
 * \return -1 if a < b, 0 if a == b, 1 if a > b
 */
